...
cmsDriver.py step2 \
    ...
    -n -1 \
    --mc \
    --python_filename digiraw-minbias-2024.py \
    --conditions auto:phase1_2024_realistic \
    --datatier GEN-SIM-DIGI-RAW \
    --eventcontent FEVTDEBUGHLT \
    --geometry DD4hepExtended2024 \
    --era Run3_2024 \
    --filein file:gensim-minbias-2024.root \
    --fileout file:digiraw-minbias-2024.root \
    --customise_commands="\
...
cmsDriver.py \
    ...
    -n -1 \
    --mc \
    --python_filename recosimdqm-minbias-2024.py \
    --conditions auto:phase1_2024_realistic \
    --datatier GEN-SIM-RECO,DQMIO \
    --eventcontent RECOSIM,DQM \
    --geometry DD4hepExtended2024 \
    --era Run3_2024 \
    --filein file:digiraw-minbias-2024.root \
    --fileout file:recosim-minbias-2024.root \
    --customise_commands="\
