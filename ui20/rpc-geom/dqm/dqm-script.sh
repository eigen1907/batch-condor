...
zellij run -- bash dqm-run.sh 2025-mu-pt10 target-geometry-change-matching
zellij run -- bash dqm-run.sh 2025-mu-pt100 target-geometry-change-matching
zellij run -- bash dqm-run.sh 2025-mu-pt1000 target-geometry-change-matching
