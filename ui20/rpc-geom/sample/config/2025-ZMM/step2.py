...
# with command line options: step2 -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2025 --conditions auto:phase1_2025_realistic --datatier GEN-SIM-DIGI-RAW -n 10 --eventcontent FEVTDEBUGHLT --geometry DD4hepExtended2025 --era Run3_2025 --filein file:step1.root --fileout file:step2.root
...
run3_GEM.toModify(gemGeometry, applyAlignment = False)
