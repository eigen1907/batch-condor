...
# with command line options: step4 -s HARVESTING:@standardValidationNoHLT+@standardDQMFakeHLT+@miniAODValidation+@miniAODDQM+@nanoAODDQM --conditions auto:phase1_2023_realistic --mc --geometry DD4hepExtended2021 --scenario pp --filetype DQM --era Run3_2023 -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
