...
# with command line options: step4 -s HARVESTING:@standardValidationNoHLT+@standardDQMFakeHLT+@miniAODValidation+@miniAODDQM --conditions auto:phase1_2017_realistic --mc --geometry Extended2017 --scenario pp --filetype DQM --era Run2_2017 -n 100 --filein file:step3_inDQM.root --fileout file:step4.root
